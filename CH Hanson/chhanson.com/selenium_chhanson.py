...
output_csv_fl = 'output_chhanson.com.csv'

#source site: https://www.chhanson.com/products
#APP url: https://app.salsify.com/catalogs/aa219f48-c2de-4127-b6a9-959ff78b0173/products/70800

app_url = 'https://app.salsify.com/catalogs/aa219f48-c2de-4127-b6a9-959ff78b0173/products/IN_CATALOG_NUM'
...
def opendriver():
    try:
        ...
        driver.get('https://app.salsify.com/catalogs/aa219f48-c2de-4127-b6a9-959ff78b0173/products/70800')
        time.sleep(10)
